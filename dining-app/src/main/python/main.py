...
def main():
    ...
    while meal_type_choice != 4 and meal_type_choice is not None:
        print("T01 dining cli")
        ...
        meal_type = meal_type_map.get(meal_type_choice)
        ...
        print(f"You are spending: ${total_cost:.2f}")
        print()
